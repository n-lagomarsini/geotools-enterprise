...
public class GpxDataStore extends AbstractFileDataStore {
    ...
    public GpxDataStore(URL url, String namespace) throws DataSourceException {
        ...
        try {
            String filePart = URLDecoder.decode(url.getFile(), "UTF-8");
            ...
            throw new DataSourceException("Unable to decode " + url + " cause " + use.getMessage());
