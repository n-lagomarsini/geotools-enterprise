...
(e.g. GeoTools 8-ENTERPRISE-SNAPSHOT). At times there will also be snapshot releases for an earlier stable branch that is still
...
You can now build your project against a snapshot release by setting it as the your version property as shown here::
    ...
    <properties>
        <geotools.version>8-ENTERPRISE-SNAPSHOT</geotools.version>
    </properties>
